...
cdt.NetworkManager = (function () {
    ...
    var setSourceLine = function (_sourceLine) {
    ...
    var sendSavedTransaction = function() {
    ...
    var communicationsActive = function() {
    ...
    var resetValidationCount = function() {
        
    };

    var haveNetwork = function() {

    };

    var processReturnMessage = function() {

    };

    var clearSavedTransactions = function() {

    };
    
    var parseXmlToDataTable = function() {

    }; 

    var loadSavedTransactionsIntoDataTable = function() {

    };

    var writeDataTableToSavedTransactions = function () {
    ...
    return {
        ...
        sendSavedTransaction: sendSavedTransaction,
        sendValidation: sendValidation,
        sendValidationEx: sendValidationEx,

        batchMode: batchMode,
        communicationsActive: communicationsActive,
        isOffline: isOffline,
        resetValidationCount: resetValidationCount,
        haveNetwork: haveNetwork,

        processReturnMessage: processReturnMessage,

        clearSavedTransactions: clearSavedTransactions,
        parseXmlToDataTable: parseXmlToDataTable,
        loadSavedTransactionsIntoDataTable: loadSavedTransactionsIntoDataTable,
        writeDataTableToSavedTransactions: writeDataTableToSavedTransactions,
...
cdt.VariableManager = (function () {
    ...
    var getNumeric = function (_namespace, _variableName) {
        var variableValue = get(_namespace, _variableName);
        var number = new Number(variableValue);
    ...
    var get = function (_namespace, _variableName) {

        var namespaceVariable = locals[_namespace];
    ...
    var setNumeric = function (_namespace, _variableName, _value) {
        if (typeof _value === 'number') {
            var newValue = _value.toFixed(cdt.Application.configuration.floatPrecision);
            set(_namespace,_variableName, newValue);
        } else {
            set(_namespace,_variableName, _value);
        }
    }

    var set = function (_namespace, _variableName, _value) {
    ...
    var getLocalNumeric = function (_variableName) {

        var variableValue = getLocal(_variableName);
        var number = new Number(variableValue);
    ...
    var getLocal = function (_variableName) {
    ...
    var setLocalNumeric = function (_variableName, _value) {

        if (typeof _value === 'number') {
            var newValue = _value.toFixed(cdt.Application.configuration.floatPrecision);
            setLocal(_variableName, newValue);
        } else {
            setLocal(_variableName, _value);
        }
    };

    var setLocal = function (_variableName, _value) {
    ...
    var getGlobalNumeric = function (_variableName) {
        var variableValue = getGlobal(_variableName);
        var number = new Number(variableValue);
    ...
    var getGlobal = function (_variableName) {
        
        return globals[_variableName];
    };

    var setGlobalNumeric = function (_variableName, _value) {
        if (typeof _value === 'number') {
            var newValue = _value.toFixed(cdt.Application.configuration.floatPrecision);
            setGlobal(_variableName, newValue);
        } else {
            setGlobal(_variableName, _value);
        }
    };

    var setGlobal = function (_variableName, _value) {

        return globals[_variableName] = _value;
    };

    var setBound = function (_variableName, _value) {


        if (typeof _variableName == undefined || _variableName == null) {
            return;
        }

        var elements = _variableName.split(".");
        ...
        switch(elements.length) {
            case 1:
                ...
                break;
            case 2:
                var type = elements[0].toLowerCase();
                if (type == "var") {
                    setLocal(elements[1], _value);
                } else if (type == "gvr") {
                    setGlobal(elements[1], _value);
                }
                break;
            case 3:
                set(elements[1], elements[2], _value);
                break;
        }
    };

    var getBound = function (_variableName) {
        var elements = _variableName.split(".");

        switch (elements.length) {
            case 1:
                return getLocal(_variableName);
            case 2:
                var type = elements[0].toLowerCase();
                if (type == "var") {
                    return getLocal(elements[1]);
                } else if (type == "gvr") {
                    return setGlobal(elements[1]);
                }
            case 3:
                return get(elements[1], elements[2]);
        }
    ...
    return {
        ...
        getLocal: getLocal,
        setLocal: setLocal,
        getLocalNumeric: getLocalNumeric,
        setLocalNumeric: setLocalNumeric,
        getGlobal: getGlobal,
        setGlobal: setGlobal,
        getGlobalNumeric: getGlobalNumeric,
        setGlobalNumeric: setGlobalNumeric,
        getBound: getBound,
        setBound: setBound
    };
})();
...
cdt.listControl = function (_name, _captionId, _selected) {
    ...
    var initialize = function () {
        ...
        //listView.setOptions({
        //    click: internalSelect
        //});

    };

    var internalSelect = function (e) {
...
cdt.prompt = function (_name, _captionId, _text,
    ...
    var validate = function (_value, _callback) {
        ...
        if (model.variableName != null) {
            cdt.VariableManager.setBound(model.variableName,_value);
        }
    ...
    var reset = function () {
        ...
        if (model.variableName != null) {
            cdt.VariableManager.setBound(model.variableName,null);
        }
...
cdt.MessageBox = (function () {
    ...
    var show = function (_title, _text, _messageBoxButton, _boundVariable, _completeAction) {

        var viewModel = new cdt.messageBox();
        kendo.bind($("#messageBoxDialog"), viewModel);
        viewModel.showDialog(_title, _text, _messageBoxButton, _boundVariable, _completeAction);
...
cdt.messageBox = (function () {
    ...
    var show = function (_title, _text, _messageBoxButton, _boundVariable, _completeAction) {
        ...
        dialogControl = $("#messageBoxDialog").data("kendoMobileModalView");
    ...
    var closeDialog = function () {
        ...
        dialogControl.close();
        // If bound variable then update with result
        cdt.VariableManager.setBound(boundVariable, dialogResult);
    };
