...
var rootMenu = [
    ...
    { name: "Unplanned Receipt", view: "frmUnplannedReceipts.html", description: "Acknowledge unplanned arrival of items.", url: "images/breeze.png", group: "Receive" },
    { name: "ASN Receipt", view: "frmASNReceipt.html", description: "Acknowledge ASN items.", url: "images/blackberry_white.png", group: "Receive" },
    { name: "ASN Receipt Verify", view: "frmASNReceipt.html", description: "Verify acknowledge ASN items.", url: "images/document_todo.png", group: "Receive" },
    ...
    { name: "Inactive IntelliLabels", view: "frmGenInactiveLabel.html", description: "Inactive IntelliLabels.", url: "images/hourglass_link.png", group: "Manufacturing" },
    ...
    { name: "Advanced Repetitive Backflush", view: "frmBackFlush.html", description: "Advanced repetitive Backflush.", url: "images/flood_it.png", group: "Manufacturing" },
    ...
    { name: "Shipper Work Bench", view: "frmShipperWB.html", description: "Load Shipment.", url: "images/cash_register.png", group: "Shipping" },
    { name: "Shipper Verify", view: "frmShipperVerify.html", description: "Load Shipment.", url: "images/chart_pie_edit.png", group: "Shipping" },
    { name: "Honda Shipments", view: "frmSOPickConHonda.html", description: "Load Shipment.", url: "images/tipper.png", group: "Shipping" },
    { name: "DO Shipments", view: "frmDOPickCon.html", description: "Load Shipment.", url: "images/forklift.png", group: "Shipping" },

    { name: "Location Transfer", view: "frmLocationTransfer.html", description: "Receive items into stock.", url: "images/drawer_open.png", group: "Inventory" },
    ...
    { name: "Tag Count", view: "frmPhysicalCount.html", description: "Reprint labels for item in stock.", url: "images/jar_open.png", group: "Count" },
    { name: "Tag Recount", view: "frmPhysicalRecount.html", description: "Reprint labels for item in stock.", url: "images/tubes.png", group: "Count" },
    ...
    { name: "Cancel Replenishment", view: "frmTMSCancelBinByLoc.html", description: "Perform a physical count of tagged items.", url: "images/tag_blue_delete.png", group: "WorkForce Director" },
    { name: "Tasks List", view: "frmTMSTaskPromptList.html", description: "Perform a physical count of tagged items.", url: "images/three_tags.png", group: "WorkForce Director" },
    { name: "Change Region", view: "frmTMSChangeRegion.html", description: "Perform a physical count of tagged items.", url: "images/map_edit.png", group: "WorkForce Director" },
